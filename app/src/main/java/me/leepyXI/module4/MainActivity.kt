...
class MainActivity : ComponentActivity() {
    ...
    fun MainScreen() {
        ...
        // Map WorkInfos to CityWeather data
        ...
        Surface(
            ...
            color = Color(0xFFF0F8FF) // Light blue background like in template
        ) {
            Column(
                modifier = Modifier
                    .systemBarsPadding()
